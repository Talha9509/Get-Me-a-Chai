...
const About = () => {
    return (
        <div className="container mx-auto px-8 md:px-10 py-8 ">
            <h1 className="md:text-5xl text-3xl font-semibold mb-4">About - Get Me a Chai</h1>
            <p className="md:text-lg text-md mb-10 mt-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:gap-20 md:mx-20 ">
                ...
                <div className="flex md:flex-row flex-col items-center mb-6   ">
                    ...
                    <div>
                        <h3 className="text-xl font-semibold mb-2 text-center">Fans Want to Collaborate</h3>
                        <p className='text-center'>Your fans are enthusiastic about collaborating with you on your projects.</p>
                    </div>
                </div>
                <div className="flex md:flex-row flex-col items-center mb-6 ">
                    <img className="w-20 h-20 rounded-full mr-4" src="/coin.gif" alt="Support Through Chai" />
                    <div>
                        <h3 className="text-xl font-semibold mb-2 text-center">Support Through Chai</h3>
                        <p className='text-center md:pr-2'>Receive support from your fans in the form of chai purchases, directly contributing to your project funding.</p>
                    </div>
                </div>
